...
_DEPS = ComplexNumber.h Fft.h Periodic.h Envelope.h Wave.h Frame.h
DEPS = $(patsubst %,$(IDIR)/%,$(_DEPS))

_OBJ = ComplexNumber.o Fft.o Periodic.o Envelope.o Wave.o Frame.o fftsg.o
...
_TESTS = FftTest.o PeriodicTest.o EnvelopeTest.o WaveTest.o CuTest.o AllTests.o
